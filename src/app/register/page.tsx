...
export default function RegisterPage() {
  ...
  const validateForm = () => {
    ...
    if (!agreedToTerms) {
      newErrors.terms = t('must_agree_terms')
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({ 
        general: error.message || t('registration_failed') 
      })
    }
  }
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900">{t('create_account')}</h2>
          <p className="mt-2 text-gray-600">{t('register_subtitle')}</p>
        </div>

        {/* Register Form */}
        <Card>
          <CardHeader>
            <CardTitle className="text-center">{t('sign_up')}</CardTitle>
          </CardHeader>
          <CardContent>
